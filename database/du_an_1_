...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 09, 2023 lúc 03:41 PM
...
(2, 3, 1, 'Chất lượng sản phẩm không tốt cho lắm', 'Sản phẩm hơi giống với mô tả', 2, '2023-11-09 21:04:03'),
(3, 2, 3, 'Trung bình', 'Khá giống', 3, '2023-11-09 21:19:26'),
(4, 1, 3, 'Sản phẩm rất chất lượng', 'Đúng với mô tả', 4, '2023-11-09 21:21:03'),
(5, 3, 4, 'Sản phẩm rất tốt vượt ngoài mong đợi', 'Rất đẹp và đúng với mô tả', 5, '2023-11-09 21:21:43');
...
INSERT INTO `gio_hang` (`id`, `id_sp`, `id_kh`) VALUES
(1, 1, 1),
(3, 3, 1);
...
(2, 'Ghế ăn cao cấp', '', 1000, 1, 'Thương hiệu: Nội Thất Nhập Khẩu - Mẫu Mới Nhất 2023\r\nNhập khẩu 100% ., Miễn phí vận chuyển,lắp đặt trong nội thành Hà Nội ', 1.00, 2, 2),
(3, 'Combo Sofa Bed Tiện Lợi Nhiều Màu', '', 200, 1, 'Combo ghế sofa cùng với bàn trà theo phong cách Hàn Quốc của Nội Thất May đo giúp căn nhà của bạn có một không gian nghỉ ngơi sau một ngày làm việc ', 4.00, 2, 1),
(4, 'Ghế sofa góc L bọc da cao cấp', '', 10000, 1, 'Kích thước: Dài 2,4m, Rộng 1,6m ( có thể thay đổi )\r\nChất Liệu: Da công nghiệp nhập khẩu Hàn Quốc ( có thể thay đổi da bò/ da PU, simili … ) Khung Gỗ Dầu đã xử lý chống mối mọt\r\nNệm mút cao cấp mang lại cảm giác êm ái dễ chịu\r\nBảo Hành: 3 năm với khung ghế, 1 năm với da và mút', 5.00, 2, 2);
